export const dict = {
  ...
  "ui.sessionTurn.status.semifAnalyzing": "SemIf analisando",
  "ui.sessionTurn.status.specialistSelected": "Especialista selecionado: {{agent}}",
  "ui.sessionTurn.status.deterministicRouting": "Roteamento determinístico · {{agent}}",
  "ui.sessionTurn.status.specialistSpecified": "Especialista definido: {{agent}}",
  "ui.sessionTurn.status.startingSpecialist": "Iniciando {{agent}}",
  "ui.sessionTurn.status.startingSpecialistBackground": "Iniciando {{agent}} em segundo plano",
  ...
  "ui.sessionTurn.thinking.elapsed": "Tempo decorrido",
  ...
  "ui.tool.task": "Tarefa",
  "ui.tool.omo_delegate": "OMO Delegate",
  "ui.tool.omo_delegate.mode.background": "Background",
  "ui.tool.omo_delegate.mode.foreground": "Foreground",
  "ui.tool.omo_delegate.state.running": "Running",
  "ui.tool.omo_delegate.state.completed": "Completed",
  "ui.tool.omo_delegate.state.error": "Error",
  "ui.tool.omo_delegate.verification": "Verification: {{value}}",
  "ui.tool.omo_delegate.provenance": "Routed by {{value}}",
  "ui.tool.omo_delegate.fallback": "Fallback: {{value}}",
  "ui.tool.omo_delegate.downgraded": "Adjusted: {{value}}",
  "ui.tool.omo_delegate.child": "Child session {{id}}",
  "ui.tool.omo_delegate.source.semif": "SemIf",
  "ui.tool.omo_delegate.source.deterministic": "deterministic routing",
  "ui.tool.omo_delegate.source.explicit": "explicit selection",
