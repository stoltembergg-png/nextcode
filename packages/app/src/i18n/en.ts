...
export const dict = {
  ...
  "semif.state.downloading_hip_runtime": "Downloading HIP runtime",
  ...
  "semif.backend.hip_downloading": "Downloading HIP runtime",
  ...
  "semif.backend.fallback.gpu_unsupported":
    "Using CPU — GPU not supported for HIP on this OS (outside supported AMD matrix)",
