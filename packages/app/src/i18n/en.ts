...
export const dict = {
  ...
  "status.popover.tab.omo": "OMO",
  "omo.status.description": "Native OMO routing and delegation",
  "omo.status.loading": "Loading native OMO status…",
  "omo.status.failed": "Native OMO status is unavailable",
  "omo.status.disabled": "Native OMO is disabled",
  "omo.status.conflict.title": "Legacy OMO plugin detected",
  "omo.status.conflict.description": "Native registration is suppressed. Review the configuration with:",
  "omo.status.preset": "Preset",
  "omo.status.agents": "Agents",
  "omo.status.routing": "Routing",
  "omo.status.routing.semif": "SemIf",
  "omo.status.routing.deterministic": "Deterministic fallback",
  "omo.status.failure": "Last routing failure",
  ...
  "semif.state.downloading_hip_runtime": "Installing HIP runtime",
  "semif.state.downloading_vulkan_runtime": "Installing Vulkan runtime",
  "semif.state.verifying": "Verifying integrity",
  "semif.state.verifying_hip_runtime": "Verifying HIP runtime",
  ...
  "semif.backend.hip_active": "HIP active",
  "semif.backend.hip_downloading": "Installing HIP runtime",
  "semif.backend.hip_verifying": "Verifying HIP runtime",
