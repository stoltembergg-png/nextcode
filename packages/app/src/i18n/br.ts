export const dict = {
  ...
  "semif.state.downloading_hip_runtime": "Instalando runtime HIP",
  ...
  "semif.backend.hip_active": "HIP ativo",
  "semif.backend.hip_downloading": "Instalando runtime HIP",
  ...
  "semif.backend.fallback.gpu_unsupported": "Esta GPU AMD não é suportada pelo build HIP atual",
